...
const Skils=()=> {
  return (
    <div className='bg-violet-50 rounded-xl m-12 p-12 text-5xl'>
      <h1 className="text-center font-yatra text-pink-600 mt-4">Skills</h1> 
      <div className='flex flex-wrap justify-center items-center flex-col md:flex-row gap-12 mt-12 mb-12'>
