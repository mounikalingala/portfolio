      ...
      <div className='flex flex-col items-center md:flex-row md:justify-between mt-8'>
        <div className='flex flex-col order-2 md:order-1 mt-12'>
          ...
          <div className='flex flex-row mb-8'>
            ...
            <h1 className='text-lg ml-4 text-gray-600 mt-1 font-semibold'>Hederabad, Telengana</h1>
          </div>
        </div>
        <div className='flex flex-col justify-center items-center order-1 md:order-2 '>
          <form onSubmit={sendEmail} >
                        ...
                        <textarea className="text-sm text-Black mb-4 w-full max-w-sm font-normal bg-transparent outline-none border h-10 p-4 border-pink-600 rounded-md h-40" name="message" placeholder='Your Message' cols="42" rows="4"></textarea> <br />
